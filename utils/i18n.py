...
TEXTS: dict[str, dict[str, str]] = {
    "UA": {
        ...
        "gdpr": (
            ...
            "Ми обробляємо, тобто збираємо та зберігаємо:\n"
            "• Ім'я, прізвище, вік, місто\n"
            "• Контактні дані (email, номер телефону)\n"
            "• Опис вашої ситуації — *дані про ментальне здоров'я (ст. 9 GDPR)*\n\n"
            "Дані використовуються виключно з метою підбору фахівця і *не передаються третім особам*.\n\n"
            "Ви можете видалити всі свої дані в будь-який час за допомогою команди /deleteme.\n\n"
            "Чи даєте ви свою *явну згоду* на обробку даних, включаючи дані про ментальне здоров'я?"
        ),
        ...
        "intake_name_invalid": "⚠️ Будь ласка, введіть ім'я та прізвище (два слова).",
        ...
        "slots_header_ikp": "📅 Доступні слоти (сесія 30 хв):",
        "slot_booked": "✅ Сесію заброньовано!\n{details}",
        "slot_reminder": "⏰ Нагадування: ваша сесія <b>через 2 години</b>.\n\n{details}",
        "slot_callback": "📞 Передзвоніть мені",
        "callback_saved": "📞 Вашу заявку прийнято!\nНаш спеціаліст зв'яжеться з вами найближчим часом.",
        "no_slots": "Наразі вільних слотів зараз немає. Ви можете записатись в лист очікування. Заповніть реєстраційну форму за посиланням — https://forms.gle/CUdnjqFD9xbVEu9Y6",
        ...
        "intake_age_number": "Вкажіть ваш вік (повних років):",
        "intake_age_number_child": "Вкажіть вік дитини (повних років):",
        "intake_age_number_invalid": "⚠️ Будь ласка, введіть вік цифрами (1–120).",
    ...
    "RU": {
        ...
        "gdpr": (
            ...
            "Мы обрабатываем, то есть собираем и храним:\n"
            ...
            "Данные используются исключительно в целях подбора специалиста и *не передаются третьим лицам*.\n\n"
            "Вы можете удалить все свои данные в любое время с помощью команды /deleteme.\n\n"
            "Даете ли вы свое *явное согласие* на обработку данных, включая данные о ментальном здоровье?"
        ),
        ...
        "intake_name_invalid": "⚠️ Пожалуйста, введите имя и фамилию (два слова).",
        ...
        "slots_header_ikp": "📅 Доступные слоты (сессия 30 мин):",
        "slot_booked": "✅ Сессия забронирована!\n{details}",
        "slot_reminder": "⏰ Напоминание: ваша сессия <b>через 2 часа</b>.\n\n{details}",
        "slot_callback": "📞 Перезвоните мне",
        "callback_saved": "📞 Ваша заявка принята!\nНаш специалист свяжется с вами в ближайшее время.",
        "no_slots": "Свободных слотов сейчас нет. Вы можете записаться в лист ожидания. Заполните регистрационную форму по ссылке — https://forms.gle/CUdnjqFD9xbVEu9Y6",
        ...
        "intake_age_number": "Укажите ваш возраст (полных лет):",
        "intake_age_number_child": "Укажите возраст ребёнка (полных лет):",
        "intake_age_number_invalid": "⚠️ Пожалуйста, введите возраст цифрами (1–120).",
    ...
    "CZ": {
        ...
        "gdpr": (
            ...
            "Zpracováváme, tj. shromažďujeme a uchováváme:\n"
            "• Jméno, příjmení, věk, město\n"
            "• Kontaktní údaje (e-mail, telefonní číslo)\n"
            "• Popis vaší situace – *údaje o duševním zdraví (čl. 9 GDPR)*\n\n"
            "Údaje se používají výhradně za účelem výběru odborníka a *nejsou předávány třetím stranám*.\n\n"
            "Všechny své údaje můžete kdykoli smazat pomocí příkazu /deleteme.\n\n"
            "Dáváte svůj *výslovný souhlas* se zpracováním údajů, včetně údajů o duševním zdraví?"
        ),
        ...
        "intake_name_invalid": "⚠️ Prosím zadejte jméno a příjmení (dvě slova).",
        ...
        "slots_header_ikp": "📅 Dostupné termíny (sezení 30 min):",
        "slot_booked": "✅ Termín zarezervován!\n{details}",
        "slot_reminder": "⏰ Připomenutí: vaše sezení <b>za 2 hodiny</b>.\n\n{details}",
        "slot_callback": "📞 Zavolejte mi zpět",
        "callback_saved": "📞 Vaše žádost byla přijata!\nNáš specialista vás brzy kontaktuje.",
        "no_slots": "Momentálně nejsou žádné volné termíny. Můžete se zapsat na čekací listinu. Vyplňte registrační formulář na odkazu — https://forms.gle/CUdnjqFD9xbVEu9Y6",
        ...
        "intake_age_number": "Uveďte svůj věk (v celých letech):",
        "intake_age_number_child": "Uveďte věk dítěte (v celých letech):",
        "intake_age_number_invalid": "⚠️ Prosím zadejte věk číslicí (1–120).",
    ...
    "EN": {
        ...
        "gdpr": (
            ...
            "We process, i.e., collect and store:\n"
            "• Name, surname, age, city\n"
            "• Contact details (email, phone number)\n"
            "• Description of your situation — *mental health data (Art. 9 GDPR)*\n\n"
            "The data is used solely for the purpose of matching you with a specialist and *is not shared with third parties*.\n\n"
            "You can delete all your data at any time using the /deleteme command.\n\n"
            "Do you give your *explicit consent* to the processing of your data, including mental health data?"
        ),
        ...
        "intake_name_invalid": "⚠️ Please enter both first and last name (two words).",
        ...
        "slots_header_ikp": "📅 Available slots (30-min session):",
        "slot_booked": "✅ Session booked!\n{details}",
        "slot_reminder": "⏰ Reminder: your session is <b>in 2 hours</b>.\n\n{details}",
        "slot_callback": "📞 Please call me back",
        "callback_saved": "📞 Your request has been received!\nOur specialist will contact you shortly.",
        "no_slots": "There are no available slots at the moment. You can join the waiting list. Please fill in the registration form at — https://forms.gle/CUdnjqFD9xbVEu9Y6",
        ...
        "intake_age_number": "Enter your age (years):",
        "intake_age_number_child": "Enter the child's age (years):",
        "intake_age_number_invalid": "⚠️ Please enter your age as a number (1–120).",
